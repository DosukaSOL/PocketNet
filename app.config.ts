...
export default {
  expo: {
    ...
    plugins: [
      ...
      'expo-notifications',
      ['expo-media-library', {
        photosPermission: 'PocketNet saves your exported profile card to your gallery.',
        savePhotosPermission: 'PocketNet saves your exported profile card to your gallery.',
